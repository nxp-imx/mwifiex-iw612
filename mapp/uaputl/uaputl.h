...
#define MAX_MAC_ONESHOT_FILTER 64
/** Maximum SSID length */
...
/** Maximum WPA3 SAE password length */
#define MAX_WPA3_SAE_PASSWORD_LENGTH 255
/** Minimum WPA3 SAE password length */
#define MIN_WPA3_SAE_PASSWORD_LENGTH 8
/** Maximum data rates */
...
/** Default max primary channel supporting secondary channel above when country
 * code is not Japan */
#define DEFAULT_MAX_CHANNEL_ABOVE 7
/** min primary channel support secondary channel below */
#define MIN_CHANNEL_BELOW 5
/** Default max primary channel supporting secondary channel above when country
 * code is not Japan and not US */
#define DEFAULT_MAX_CHANNEL_ABOVE_NON_US 9
/** Default max primary channel supporting secondary channel below when country
 * code is not Japan */
...
/** TLV buffer : WPA3 SAE password */
typedef PACK_START struct _tlvbuf_wpa3_sae_password {
	/** Header */
	TLVHEADER;
	/** WPA3 SAE password */
	t_u8 password[];
} PACK_END tlvbuf_wpa3_sae_password;
...
/** Reg TYPE*/
enum reg_commands { CMD_MAC = 1, CMD_BBP, CMD_RF };
...
/** Regulatory Domain Type */
#define NXP_DFS_UNSET 0
#define NXP_DFS_FCC 1
#define NXP_DFS_ETSI 2
#define NXP_DFS_JP 3
#define NXP_DFS_MAX 4
#define NXP_DFS_UNKNOWN 0xFF

/** Regulatory Domain */
typedef PACK_START struct reg_domain_param {
	/** Header */
	TLVHEADER;
	t_u8 regDomain; /**< Regulatory Domain */
} PACK_END reg_domain_param_t;
...
typedef PACK_START struct domain_param {
	...
	ieeetypes_subband_set_t subband[]; /**< Set of subbands */
...
#define MAX_CFG_DATA_SIZE 3000 /* less than MRVDRV_SIZE_OF_CMD_BUFFER */
...
#define MRVL_STA_MAC_ADDR_FILTER_TLV_ID                                        \
...
/** TLV : WPA3 SAE password */
#define MRVL_WPA3_SAE_PASSWORD_TLV_ID (PROPRIETARY_TLV_BASE_ID + 0x141) // 0x0241
...
#define MRVL_RESTRICT_CLIENT_MODE_TLV_ID                                       \
	(PROPRIETARY_TLV_BASE_ID + 0xC1) // 0x01C1
/** TLV : Sticky TIM config */
#define MRVL_STICKY_TIM_CONFIG_TLV_ID (PROPRIETARY_TLV_BASE_ID + 0x96) // 0x0196
/** TLV : Sticky TIM MAC address */
#define MRVL_STICKY_TIM_STA_MAC_ADDR_TLV_ID                                    \
	(PROPRIETARY_TLV_BASE_ID + 0x97) // 0x0197
/** TLV : 20/40 coex config */
#define MRVL_2040_BSS_COEX_CONTROL_TLV_ID                                      \
...
/** Enumeration for band steering actions */
typedef enum _bandSteerAct {
	ACT_GET = 0,
	ACT_SET_STATE = 1,
	ACT_SET_BLOCK_2G_PRB_REQ = 2,
	ACT_SET_MAX_BTM_REQ_ALLOWED = 4,
} bandSteerAct;
...
#define MRVL_AP_EXT_CAP_LEN_TLV_ID (PROPRIETARY_TLV_BASE_ID + 0x148)

/** TLV buffer : Extended Capabilities Length*/
typedef PACK_START struct _tlvbuf_ap_ext_cap_len_ {
	/** Header */
	TLVHEADER;
	/** Extended Capabilities IE Length */
	t_u8 ext_cap_len;
} PACK_END tlvbuf_ext_cap_len;
 ...
 */
static inline int has_diff_band(int argc, char *argv[])
{
	int i = 0;
	int channel = 0;
