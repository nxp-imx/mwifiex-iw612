 ...
 *  $return         N/A
 */
static void print_sys_cfg_ap_mac_address_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_ssid_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_beacon_period_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_dtim_period_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_bss_status_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_channel_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_channel_ext_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_scan_channels_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_rates_ext_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_rates_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_tx_power_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_bcast_ssid_ctl_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_rsn_replay_prot_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_preamble_ctl_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_antenna_ctl_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_rts_threshold_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_frag_threshold_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_tx_beacon_rates_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_mcbc_data_rates_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_auth_usage(void)
{
	/* used for embedded supplicant*/
	printf("\nUsage : sys_cfg_auth [AUTHMODE] [PWE derivation] [transition disable]\n");
	printf("\nOptions: AUTHMODE :     0 - Open authentication");
	printf("\n                        1 - Shared key authentication");
	printf("\n                        255 - Auto (Open and Shared key) authentication");
	/* used for embedded supplicant*/
	printf("\nOptions: PWE derivation:0 - Looping only (default)");
	printf("\n                        1 - H2E only");
	printf("\n                        2 - Both looping and H2E");
	printf("\nOptions: transition disable: 0 - transition enable (default)");
 ...
 *  $return         N/A
 */
static void print_sys_cfg_pkt_fwd_ctl_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_sta_ageout_timer_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_ps_sta_ageout_timer_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_protocol_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_wep_key_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_cipher_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_pwk_cipher_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_gwk_cipher_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_group_rekey_timer_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_wpa_passphrase_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_wpa3_sae_password_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_max_sta_num_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_retry_limit_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_sticky_tim_config_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_sticky_tim_sta_mac_addr_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_2040_coex_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_eapol_pwk_hsk_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_eapol_gwk_hsk_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_cfg_data_usage(void)
{
 ...
 *  $return         N/A
 */
static void print_sys_cfg_wacp_mode(void)
{
...
/**
 *  @brief Show usage information for the sys_cfg_ext_cap_len
 *   command
 *
 *  $return         N/A
 */
static void print_sys_cfg_ext_cap_len(void)
{
	printf("\nUsage : sys_cfg_ext_cap_len <value>\n");
	printf("\nIf <value> is provided, a 'set' is performed, else a 'get' is performed.\n");
	return;
}
...
int get_sys_cfg_rates(t_u8 *rates)
{
	...
	cmd_len = sizeof(apcmdbuf_sys_configure) + sizeof(tlvbuf_rates) +
		  MAX_DATA_RATES;
...
int apcmd_sys_cfg_ssid(int argc, char *argv[])
{
	...
	if (argc == 0) {
		/* Initialize the command length */
		cmd_len = sizeof(apcmdbuf_sys_configure) + sizeof(tlvbuf_ssid) +
			  MAX_SSID_LENGTH;
	} else {
...
#define DFS_JAPAN_RADAR_CHANNEL_END 144
 ...
 *  @return     Region code
 */
static regdomain_e region_string_2_region_code(t_u8 *region_string)
{
	t_u8 i;
	...
	if (argc == 0) {
		...
		if (argc == 1) {
			...
			if (mode & BITMAP_ACS_MODE) {
				int dfs_mode;
				if (uap_ioctl_dfs_repeater_mode(&dfs_mode) ==
				    UAP_SUCCESS) {
					if (dfs_mode) {
 ...
 *           if CHANNEL is provided, a 'set' is performed
 *           else a 'get' is performed
 *           if BAND is provided, a 'set' is performed with band
 * info(2.4GHz/5GHz) if MODE is provided, a 'set' is performed with mode
 * (ACS/secondary channel)
 *
 *  @param argc     Number of arguments
 *  @param argv     Pointer to the arguments
 *  @return         UAP_SUCCESS/UAP_FAILURE
 ...
 *
 */
static void parse_input(int argc, char **argv, int output[3][2])
{
	int i, j, k = 0;
...
int apcmd_sys_cfg_rates_ext(int argc, char *argv[])
{
	...
	if (argc) {
		...
		if ((output[1][0] != -1) && (output[1][1] > output[1][0])) {
			...
			mflag = 1;
			argv_mrate[0] = (char *)malloc(sizeof(char) *
						       (strlen(argv[j]) + 1));
		...
		if (mflag && is_input_valid(MCBCDATARATE, 1, argv_mrate) !=
				     UAP_SUCCESS) {
	...
	if (ret == UAP_SUCCESS) {
		if (cmd_buf2->result == CMD_SUCCESS) {
			if (cmd_buf2->domain.country_code[0] ||
				...
				no_of_sub_band = parse_domain_file(
					country, band, sub_bands, NULL);
				if (no_of_sub_band == UAP_FAILURE) {
					printf("Parsing of domain configuration file failed\n");
					ret = UAP_FAILURE;
					goto done;
 ...
 *   Usage: "sys_cfg_pkt_fwd_ctl [PKT_FWD_CTRL]"
 *
 *   PKT_FWD_CTRL: bit 0 -- Packet forwarding handled by Host (0) or Firmware
 * (1) bit 1 -- Intra-BSS broadcast packets are allowed (0) or denied (1) bit 2
 * -- Intra-BSS unicast packets are allowed (0) or denied (1) bit 3 -- Inter-BSS
 * unicast packets are allowed (0) or denied (1) empty - Get current packet
 * forwarding setting
 *
 *  @param argc     Number of arguments
 *  @param argv     Pointer to the arguments
...
int apcmd_sys_cfg_sta_ageout_timer(int argc, char *argv[])
{
	...
	/* Check arguments */
	if (argc &&
	    (is_input_valid(STAAGEOUTTIMER, argc, argv) != UAP_SUCCESS)) {
		print_sys_cfg_sta_ageout_timer_usage();
		return UAP_FAILURE;
	}
	/* Initialize the command length */
...
int apcmd_sys_cfg_auth(int argc, char *argv[])
{
	...
	if (argc == 0) {
		...
		/* used for embedded supplicant */
		if (argc > 1 && argv[1] != 0) {
			tlv->PWE_derivation = (t_u8)atoi(argv[1]);
		}
		if (argc > 2 && argv[2] != 0) {
			tlv->transition_disable = (t_u8)atoi(argv[2]);
		}
	}
	endian_convert_tlv_header_out(tlv);
	/* Send the command */
...
int apcmd_sys_cfg_protocol(int argc, char *argv[])
{
	...
	do {
		...
		if (argc == 0) {
			...
			if (tlv->protocol &
			    (PROTOCOL_WPA | PROTOCOL_WPA2 | PROTOCOL_WPA3_SAE |
			     PROTOCOL_OWE)) {
				akmp_tlv->tag = MRVL_AKMP_TLV_ID;
				akmp_tlv->length = 4; /* sizeof(tlvbuf_akmp) -
							 TLVHEADER_LEN */
 ...
 *   and sends to the driver
 *
 *   Usage: "sys_cfg_wep_key [INDEX_0 IS_DEFAULT KEY_0] [INDEX_1 IS_DEFAULT
 * KEY_1] [INDEX_2 IS_DEFAULT KEY_2] [INDEX_3 IS_DEFAULT KEY_3]"
 *
 *   Options: INDEX_* :      0 - KeyIndex is 0
 *                           1 - KeyIndex is 1
 *                           2 - KeyIndex is 2
...
int apcmd_sys_cfg_wep_key(int argc, char *argv[])
{
	...
	for (i = 0; i < number_of_keys; i++) {
		...
		tmp_buffer = realloc(
			buffer, (cmd_len + sizeof(tlvbuf_wep_key) + key_len));
		if (!tmp_buffer) {
 ...
 *		           2 - Block MAC addresses specified in the  banned list
 *            MACADDRESS_LIST is the list of MAC addresses to be acted upon.
 *Each MAC address must be separated with a space. Maximum of 16 MAC addresses
 *are supported.
 *
 *  @param argc     Number of arguments
 *  @param argv     Pointer to the arguments
...
int apcmd_sys_cfg_sticky_tim_sta_mac_addr(int argc, char *argv[])
{
	...
	if (argc < 2) {
		...
		if (argc == 0) {
			tlv->length = 0;
			cmd_len -= sizeof(tlvbuf_sticky_tim_sta_mac_addr) -
				   TLVHEADER_LEN;
		}
		if ((argc == 1) &&
...
int apcmd_sys_cfg_2040_coex(int argc, char *argv[])
{
	...
	/* Check arguments */
	if (argc &&
	    (is_input_valid(COEX2040CONFIG, argc, argv) != UAP_SUCCESS)) {
		print_sys_cfg_2040_coex_usage();
		return UAP_FAILURE;
	}
	/* Initialize the command length */
...
int apcmd_sys_cfg_eapol_pwk_hsk(int argc, char *argv[])
{
	...
	/* Check Arguments */
	if (argc &&
	    (is_input_valid(EAPOL_PWK_HSK, argc, argv) != UAP_SUCCESS)) {
		print_sys_cfg_eapol_pwk_hsk_usage();
		return UAP_FAILURE;
	}
...
int apcmd_sys_cfg_eapol_gwk_hsk(int argc, char *argv[])
{
	...
	/* Check Arguments */
	if (argc &&
	    (is_input_valid(EAPOL_GWK_HSK, argc, argv) != UAP_SUCCESS)) {
		print_sys_cfg_eapol_gwk_hsk_usage();
		return UAP_FAILURE;
	}
	/* Initialize the command length */
 ...
 *  $return         N/A
 */
static void print_sys_cfg_11n_usage(void)
{
...
void print_rx_packet_coalesc_help()
{
...
int apcmd_sys_cfg_11n(int argc, char *argv[])
{
	...
	if (!argc) {
		...
		if (atoi(argv[0]) == 0) {
			...
			memcpy(&tlv->ht_cap, &htcap, sizeof(HTCap_t));
			if (argc >= 2) {
				tlv->ht_cap.ht_cap_info = DEFAULT_HT_CAP_VALUE &
							  ~HT_CAP_CONFIG_MASK;
				tlv->ht_cap.ht_cap_info |=
					(t_u16)A2HEXDECIMAL(argv[1]) &
					HT_CAP_CONFIG_MASK;
				tlv->ht_cap.ht_cap_info = uap_cpu_to_le16(
					tlv->ht_cap.ht_cap_info);
				is_40MHz_supported =
 ...
 *  $return         N/A
 */
static void print_sys_cfg_wmm_usage(void)
{
...
*  $return         N/A
*/
static void print_sys_cfg_ap_wmm_usage(void)
{
 ...
 *  @return         UAP_SUCCESS/UAP_FAILURE
 */
static int get_wmm_parameters(WmmParameter_t *pWmm, t_u16 tlv_tag)
{
	apcmdbuf_sys_configure *cmd_buf = NULL;
 ...
 *  $return         N/A
 */
static void print_sys_cfg_restrict_client_mode_usage(void)
{
...
int apcmd_sys_cfg_restrict_client_mode(int argc, char *argv[])
{
	...
	if (argc == 0) {
		...
		tlv->mode_config = (t_u16)(
			(tlv->mode_config | RESTRICT_CLIENT_MODE_ENABLE_MASK) &
			atoi(argv[0]));
		if (argc == 2) {
...
/**
 *  @brief Creates a sys_cfg request to set/get extended capabilities IE length.
 *
 *   Usage: "sys_cfg_ext_cap_len <length>"
 *
 *  @param argc     Number of arguments
 *  @param argv     Pointer to the arguments
 *  @return         UAP_SUCCESS/UAP_FAILURE
...
int apcmd_sys_cfg_ext_cap_len(int argc, char *argv[])
{
	...
	/* Check arguments */
	if (argc &&
	    (is_input_valid(AP_EXT_CAP_LEN, argc, argv) != UAP_SUCCESS)) {
		print_sys_cfg_ext_cap_len();
		return UAP_FAILURE;
	}

	/* Initialize the command length */
	cmd_len = sizeof(apcmdbuf_sys_configure) + sizeof(tlvbuf_ext_cap_len);
	...
	/* Locate headers */
	cmd_buf = (apcmdbuf_sys_configure *)buffer;
	tlv = (tlvbuf_ext_cap_len *)(buffer + sizeof(apcmdbuf_sys_configure));
	...
	cmd_buf->seq_num = 0;
	cmd_buf->result = 0;
	tlv->tag = MRVL_AP_EXT_CAP_LEN_TLV_ID;
	tlv->length = 1;
	if (argc == 0) {
		cmd_buf->action = ACTION_GET;
	} else {
		cmd_buf->action = ACTION_SET;
		tlv->ext_cap_len = (t_u8)atoi(argv[0]);
	}
	endian_convert_tlv_header_out(tlv);
	/* Send the command */
	ret = uap_ioctl((t_u8 *)cmd_buf, &cmd_len, buf_len);
	...
	if (ret == UAP_SUCCESS) {
		...
		if (cmd_buf->result == CMD_SUCCESS) {
			if (argc == 0) {
				printf("Extended Capability IE Length %d\n",
				       tlv->ext_cap_len);
			} else {
				printf("Extended Capability IE Length setting successful!\n");
			}
		} else {
			if (argc == 0) {
				printf("ERR:Could not get Extended Capability IE Length !\n");
			} else {
				printf("ERR:Could not set Extended Capability IE Length !\n");
			}
			ret = UAP_FAILURE;
		}
	} else {
